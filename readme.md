...
**Agent Architecture (Easy Explanation)**

**1️⃣ Planner Agent**
- Understands what the user wants
- Breaks it into steps
- Example: "Scale ECS service" → Check current tasks → Find best practices → Plan scaling change
...
**4️⃣ Executor Agent**
- Applies Terraform
- Uses AWS APIs safely
- No direct uncontrolled actions
